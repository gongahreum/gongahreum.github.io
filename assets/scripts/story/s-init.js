...
var horizontalGuide = function horizontalGuide() {
  ...
  horizontalGuideSet = setTimeout(function () {
    document.querySelector(".sticky-wrap.sticky1 .sticky-con").style.height =
      window.innerHeight + "px";
  }, 150);
  var scrollParent = !document.documentElement.classList.contains("mobile")
    ? window
    : document.querySelector("#story-wrap");
  var currentScrollOffset = !document.documentElement.classList.contains(
    "mobile"
  )
    ? window.pageYOffset
...
// init
window.scrollTo(0, 0);
document.getElementById("story-scroll-container").style.paddingRight =
  getScrollbarWidth() + "px";
document.querySelector(".does-page-btn").style.height =
  window.innerHeight + "px";
document.querySelector(".does-page-btn").style.right =
  getScrollbarWidth() + "px";
